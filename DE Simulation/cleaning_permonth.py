...
# Path for the March CSV file
input_file_path = r"C:\ProgramData\MySQL\MySQL Server 8.0\Uploads\March-2023.csv"
output_file_path = r"C:\ProgramData\MySQL\MySQL Server 8.0\Uploads\Clean\March-2023_clean.csv"

# Read the March CSV file into a DataFrame
df = pd.read_csv(input_file_path)

# Check if 'DateBooked' column exists and apply the conversion
if 'DateBooked' in df.columns:
    # Apply the swap function to the 'DateBooked' column
